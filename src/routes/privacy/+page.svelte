<svelte:head>
	...
	<script type="application/ld+json">
	{
		...
		"url": "https://snkrfinder.net/privacy",
		"publisher": {
			"@type": "Organization",
			"name": "SNKRFinder",
	...
	<div class="privacy-container">
		...
		<section class="policy-section">
			...
			<ul>
				...
				<li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SNKRFinder.</li>
				<li><strong>Cookies</strong> are small files that are placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</li>
				...
				<li><strong>Website</strong> refers to SNKRFinder, accessible from https://snkrfinder.net/</li>
